...
public class Methods {
	...
	/*
	 * returns a double that represents the sum of the list divided by the lenght of the list or ther averaage 
	 * @param list 	a list of doubles represnting the list inputed that will be averaged 
	 */
	public static double arrayMean(double[] list)
	{
		double sum = 0;
